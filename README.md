...
- **น้องกุ้ง CEO เดินตรวจงาน** --- สวมมงกุฎทอง ตัวใหญ่ 1.3x สีทอง เดินทุกโต๊ะ (active + idle) ไม่หายไป (physics-based)
- **CEO ถือค้อนเคาะหัว** 🔨 --- หยุดที่โต๊ะ → หันหน้าหาพนักงาน → แกว่งค้อน + เรียกชื่อพนักงาน
- **CEO ดึงผลงานจริง** 📋 --- 40% โอกาส CEO อ่านผลงานล่าสุดจาก MongoDB แล้ว AI สร้างบทสนทนาติดตามผล + ทะเลาะตลกๆ
- **TTS เสียงไทย Neural** --- CEO เสียง Niwat (ชาย) พนักงานเสียง Premwadee (หญิง) คนละโทนชัดเจน + auto-reset ไม่ค้าง
- **AI สร้างบทสนทนาอัตโนมัติ** --- ทุก 1 ชม. AI สร้าง 20 คู่ถาม-ตอบใหม่ จับคู่สัมพันธ์กัน ตลก แซว
