...
const CUSTOMER_MESSAGES = [
  ...
  // ร้องเรียน
  "ทำไมยังไม่ส่งครับ สั่งไป 3 วันแล้ว", "ของที่ส่งมาแตก 5 ถุง", "เหล็กที่ส่งมาไม่ครบ",
  "ปูนที่ส่งมาเป็นรุ่นเก่า", "ติดต่อไปไม่มีใครรับสาย", "ส่งของผิดครับ สั่ง 12mm ได้ 10mm",
  // ทั่วไป
...
const STAFF_REPLIES = [
  ...
  "ขออภัยครับ จะรีบจัดส่งให้ทันที", "ของล็อตใหม่เข้าสัปดาห์หน้าครับ",
  "รบกวนส่งสลิปมาด้วยนะครับ", "ตอนนี้ซื้อปูน 50 ถุง แถมถุงมือ 2 คู่ครับ",
  "ขอบคุณครับ 🙏 ยินดีเสมอครับ", "เปลี่ยนได้ครับ ส่งกลับมาที่หน้าร้านเลย",
  "ปูนรุ่นนี้เหมาะกับงานฉาบครับ", "เหล็กรุ่นนี้ได้มาตรฐาน มอก. ครับ",
...
export async function POST() {
  ...
  try {
    ...
    const GROUP_MESSAGES = [
      ...
      "ปูนรุ่นนี้ดีครับ ช่างชอบ", "ใครเคยใช้ Q-CON บ้าง", "ส่งรูปสินค้าจริงให้ดูหน่อย",
      "ราคานี้รวม VAT มั้ย", "มีบริการจัดส่งหน้างานมั้ย", "ขนส่งรถ 6 ล้อได้มั้ย",
      "ขอ catalog วัสดุก่อสร้างหน่อย", "พรุ่งนี้ไปรับของที่ร้านได้มั้ย", "มีของพร้อมส่งมั้ย",
      "งานนี้ต้องใช้ปูนกี่ถุง", "อิฐบล็อกกับอิฐมวลเบาอันไหนดีกว่า",
      "ช่างแนะนำยี่ห้อไหนครับ", "ขอบคุณที่จัดส่งไวครับ 🙏", "ของดี ราคาถูกกว่าที่อื่น",
